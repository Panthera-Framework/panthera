...
switch ($_GET['menu'])
{
    ...
    case '':
        ...
        $menu[] = array('link' => 'javascript:createPopup(\'_ajax.php?display=upload&popup=true&callback=upload_file_callback\', 1300, 550);', 'name' => localize('Uploads'), 'icon' => '{$PANTHERA_URL}/images/admin/menu/uploads.png');
    break;
}
