...
// register plugin
$pluginInfo = array('name' => 'Facebook Integration', 'author' => 'Mateusz Warzyński', 'description' => 'Integration with Facebook', 'version' => PANTHERA_VERSION, 'configuration' => '?display=facebook&action=settings&cat=admin');
