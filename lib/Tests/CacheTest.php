<?php
use Panthera\Components\Cache\Loader;
...
class CacheTest extends PantheraFrameworkTestCase
{
    ...
    public function testClearCache()
    {
        ...
        $this->app->cache->set('test', true, 1);
        $this->app->cache->clear(3);
        $this->assertEquals('1', $this->app->cache->get('test'));
    }
    ...
    {
        $this->setup();
        $this->assertSame($this->app->cache, Loader::getInstance());
    }
}