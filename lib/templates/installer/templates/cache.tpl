...
<div class="header">
        ...
        <div style="margin-left: 5px;"><span>{function="localize('Please spent a minute on setting caching settings, correct settings can improve your application performance even on 2-3 times. You can handle more users without need to buy better hardware.', 'installer')"}</span></div>
</div>
