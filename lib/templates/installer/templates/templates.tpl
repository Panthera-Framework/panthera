...
<div class="header">
        ...
        <div style="margin-left: 5px;"><span>{function="localize('Every website needs a layout and a template describing it. You need to create a default template for your application, and optionaly make views for mobile devices.', 'installer')"}</span></div>
</div>
...
<div class="content" style="margin-left: 0px; padding: 0;">
    <table class="table" style="margin: 0 auto; width: 80%; margin-top: 30px;">
        ...
        <tbody>
            ...
            <tr>
                <td><input type="text" name="createNew" id="createNew" placeholder="default" style="min-width: 30px;"> <input type="button" class="button" onclick="createNewTemplate()" value="{function="localize('Create new', 'installer')"}" style="width: 30%; max-width: 100px;"></td>
