...
<form action="?save=True" method="POST" id="simpleConfigurationSubmit">
    <table class="table" style="width: 80%; margin: 0 auto; margin-top: 30px;">
        <tbody>
            <!-- system settings -->
            <tr><td colspan="2"><b>{function="localize('System settings', 'installer')"}</b></td></tr>
            ...
            <!-- mailing -->
            <tr><td colspan="2"><b>{function="localize('Mailing', 'installer')"}</b></td></tr>
            <tr>
            ...
            <!-- session and cookies -->
            <tr><td colspan="2"><b>{function="localize('Session and cookies', 'installer')"}</b></td></tr>
