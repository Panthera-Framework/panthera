         ...
         <tbody>
              {loop="$plugins"}
                <tr>
                    ...
                    <td><a href="#" onclick="togglePlugin('{$value.name}', {if="$value.enabled == True"}0{else}1{/if});">
                    ...
                    <td><a href="#" onclick="togglePlugin('{$value.name}', {if="$value.enabled == True"}0{else}1{/if});">{$value.title}</a></td>
