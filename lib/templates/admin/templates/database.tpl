...
<div class="ajax-content" style="text-align: center;">
            ...
            <tfoot style="background: transparent;">
                <tr>
                    <td colspan="5" class="rounded-foot-left">
                        <input type="button" value="{function="localize('Manage backups', 'database')"}" onclick="panthera.popup.toggle('element:#sqlDump')" style="float: right;">
                        <input type="button" value="{function="localize('Manage permissions', 'messages')"}" onclick="createPopup('_ajax.php?display=acl&cat=admin&popup=true&name=can_manage_databases', 1024, 'upload_popup');" style="float: right; margin-right: 7px;">
                    </td>
                </tr>
            </tfoot>
    ...
    <table style="display: inline-block; padding-top: 20px;">
