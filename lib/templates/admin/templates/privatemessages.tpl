...
<div class="grid-1">
        ...
        <div class="content-gird">
             ...
             <input type="text" name="recipient_login" id="recipient" placeholder="{function="localize('Recipient login', 'pmessages')"}" disabled>
             <input type="button" value="{function="localize('Select', 'pmessages')"}" onclick="createPopup('_ajax.php?display=privatemessages&cat=admin&action=select&callback=getContactData', 1024, 'upload_popup');">
