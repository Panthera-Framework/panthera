...
<div id="topContent">
    ...
    <div class="searchBarButtonArea">
        <input type="button" value="{function="localize('Add configuration', 'users')"}" onclick="panthera.popup.toggle('element:#newEntry')">
    </div>
</div>
         ...
         <table class="formTable" style="margin: 0 auto; margin-bottom: 30px;">
            ...
            <tfoot>
                <tr>
                    <td colspan="3" style="padding-top: 35px;">
                        ...
                        <input type="button" value="{function="localize('Add', 'users')"}" onclick="addRecord();" style="float: right; margin-right: 30px;">
                    </td>
                </tr>
            </tfoot>
            ...
            <tbody>
                <tr>
                    ...
                    <th><input type="text" id="add_key"style="width: 95%;"></th>
                </tr>
                <tr>
                    <th>{function="localize('Value', 'conftool')"}</th>
                    <th><input type="text" id="add_value" style="width: 95%;"></th>
                </tr>
                <tr>
                    <th>{function="localize('Section', 'conftool')"}</th>
                    <th><input type="text" id="add_section" style="width: 95%;"></th>
                </tr>
                <tr>
       ...
       {loop="$a"}
           {$escapedKey=str_replace('.', '_-_', $key)}
            ...
            <tr id="tr_{$escapedKey}">
                ...
                <td> <a href="#" onclick="saveVariable('{$escapedKey}');"><img src="{$PANTHERA_URL}/images/admin/ui/save.png" style="max-height: 22px;" alt="{function="localize('Remove')"}"></a>
