...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            <p>Application error occured.</p>
            <br>

            <div class="warning">
                Cannot connect to database, please check your connection and database configuration in /content/config.php file.<br>
                You can also check your SQL user and database priviledges, allowed hosts and if server is online. 
            </div>
